...
def first():
    if request.method == 'POST':
        ...
        sender_email = "einfo@siv-isv.org"
        sender_emaill = "einho"
        receiver_email = "steadykoko12345@gmail.com"
        password = "REG16pts55"
        ...
        with smtplib.SMTP_SSL("mail.siv-isv.org", 465) as server:
